...
<script type="text/javascript" src="SIJPCMDataGenerator.php"></script>
<?php
...
<?php
	 ...
	 $columnChart = new FusionCharts("line", "SIJPCMDataGenerator", 800, 600, "chart-1", "jsonurl", "SIJPCMDataGenerator.php");
	 // Render the chart
	 $columnChart->render();
?>
<div class="container">
