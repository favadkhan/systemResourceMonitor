...
<script type="text/javascript" src="vmFreeMemoryDataGenerator.php"></script>
<?php
...
<?php
	 ...
	 $columnChart = new FusionCharts("Column2D", "vmFreeMemoryDataGenerator", 800, 600, "chart-1", "jsonurl", "vmFreeMemoryDataGenerator.php");
	 // Render the chart
	 $columnChart->render();
?>
<div class="container">
